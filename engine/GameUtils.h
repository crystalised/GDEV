...
const D3DXCOLOR		ORANGE_COL = D3DXCOLOR(1.0f, 0.5f, 0.0f, 1.0f);
const D3DXCOLOR		 GOLD_COL = D3DXCOLOR(1.0f, 0.954f, 0.392f, 1.0f);
const D3DXCOLOR		RUBY_COL = D3DXCOLOR(0.88f, 0.07f, 0.25f, 1.0f);
const D3DXCOLOR		EMERALD_COL = D3DXCOLOR(0.31f, 0.78f, 0.47f, 1.0f);
const D3DXCOLOR		SAPPHIRE_COL = D3DXCOLOR(0.03f, 0.15f, 0.40f, 1.0f);
const D3DXCOLOR    CREDIT_COL(D3DCOLOR_XRGB(84, 74, 77)); //Color for credit scene
const D3DXCOLOR    HELP_COL(D3DCOLOR_XRGB(61, 22, 35)); //Color for help scene
...
const int WSADRF_KEYS[]={'A','D','F','R','S','W'};
...
const int CURSOR_HPR_KEYS[] = { VK_UP, VK_DOWN, VK_LEFT, VK_RIGHT, 0, 0 };
