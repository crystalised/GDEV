...
public:
	...
	*/
	...
	void Yaw(float amount){mHpr.y+=amount;}
	/// Pitches the by the amount of radians, this is turning down
	void Pitch(float amount){mHpr.x+=amount;}
...
public:	// all are public for easy access
	...
	int mLife;		///< life level of object if <=0 its to be removed
public:
...
public:
	...
	CCameraNode(const D3DXVECTOR3& pos=D3DXVECTOR3(0,0,0),
				const D3DXVECTOR3& turn=D3DXVECTOR3(0,0,0),
				float fov=D3DX_PI/4, float aspect=1.777f,float nearDist=1.f,float farDist=1000.f);
